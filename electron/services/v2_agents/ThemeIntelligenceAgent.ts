...
3. 각 테마/섹터의 등급(S/A/B) 및 주도주 풀을 바탕으로 상승 시너지가 확실한 경우, 대장/부대장 주식들을 직접 '관심종목 풀'로 추천하십시오. 시장 전체를 주도하는 진짜 알짜 종목 위주로 총합 최대 5~6개 내외로 'stock_picks' 배열에 담으십시오. 확신도(confidence)는 60~100 사이로 매기십시오.
