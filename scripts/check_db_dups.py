...
track_tables = [t for t in tables if 'track' in t or 'pick' in t]
print('Track/Pick tables:', track_tables)

# Check the ones that exist
buy_tables = [t for t in track_tables if 'buy_picks' in t]
print('Buy pick tables:', buy_tables)

if buy_tables:
    # Check duplicates across existing tables
